...
const DeclarationModal_vue_vue_type_style_index_0_scoped_9e762dc1_lang = "";
const _sfc_main$1 = {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    ...
    style: { "--bs-bg-opacity": ".5" }
  }, _attrs))} data-v-9e762dc1><div class="${ssrRenderClass([$data.isOpenModal && "active", "message-modal-content position-absolute top-50 start-50 px-3 py-4 bg-light d-flex flex-column"])}" data-v-9e762dc1><div class="text-end" data-v-9e762dc1><button type="button" class="link-primary bg-light border-0 mb-4" data-v-9e762dc1>`);
  _push(ssrRenderComponent(_component_font_awesome_icon, { icon: ["fas", "x"] }, null, _parent));
  _push(`</button></div><div class="message px-3 py-3 flex-grow overflow-y-auto" data-v-9e762dc1><p data-v-9e762dc1>Welcome to Dear K!</p><p data-v-9e762dc1> This website is a demonstration created solely for showcasing my skills as a web developer. It is not a real online shop, and no actual purchases can be made. The products and prices displayed are for illustrative purposes only. </p><p class="mb-1" data-v-9e762dc1> Feel free to explore the website, create account, add items to your cart, and proceed to the checkout to see the functionality in action. We suggest you entering random data for testing. However, please provide a valid email address for verification purposes during the registration process. You can use a disposable or temporary email address to ensure your privacy and security. Also, please use the following card number for successful payment: </p><p class="text-center fs-6 text-primary" data-v-9e762dc1><code data-v-9e762dc1>4242 4242 4242 4242</code></p><p data-v-9e762dc1> Some images used on this website may have been sourced from the internet for visual representation. If you believe any content used here infringes upon copyright or contains inappropriate material, kindly contact me so that I can address the concern promptly. </p><p data-v-9e762dc1> Thank you for visiting, and I hope you enjoy browsing my website! </p><p data-v-9e762dc1> Yuki </p></div><div class="d-grid gap-2 mt-5" data-v-9e762dc1><button type="button" class="btn btn-secondary py-2 text-white rounded-0" data-v-9e762dc1>Start Exploring</button></div></div></div>`);
}
...
const DeclarationModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-9e762dc1"]]);
const _sfc_main = {
  name: "Layout",
  components: {
    Announcement,
